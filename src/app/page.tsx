      ...
      <div className="flex flex-col items-center text-center mt-32">
        ...
        {session ? (
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 w-full max-w-md">
            ...
            {/* The POST form is required by NextAuth for providers like Google when used outside of the default signin page */}
            <form action="/api/auth/signin/google" method="POST">
              <button type="submit" className="flex items-center justify-center gap-3 w-full py-3 px-4 border border-slate-300 hover:bg-slate-50 text-slate-800 rounded-lg font-medium transition-colors">
